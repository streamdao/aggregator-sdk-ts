...
export const STREAM_PROTOCOL_PROGRAM_ID = new PublicKey('1SoLTvbiicqXZ3MJmnTL2WYXKLYpuxwHpa4yYrVQaMZ');
...
// export const STREAM_PROTOCOL_PROGRAM_ID = new PublicKey('6WxqDJMpbpTLFSW2SCnaBxLY8XZeStmGvum4fhnrSwcV');
...
export const STREAM_NAME = 'Stream'
